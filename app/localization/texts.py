...
_DYNAMIC_LANGUAGE_CONFIGS = {
   'ru': {
    ...
    'support_info': (
        '\n🛟 <b>Поддержка</b>\n\n'
        'Это центр обращений: создавайте заявки, просматривайте ответы и историю.\n\n'
        '• 📝 Создать обращение — опишите проблему или вопрос\n'
        '• 📋 Мои обращения — статус и переписка\n'
        '• 💬 Связаться — написать напрямую (если нужно)\n\n'
        'Старайтесь использовать обращения — так мы быстрее поможем и ничего не потеряется.\n'
    ),
},
    'fa': {
